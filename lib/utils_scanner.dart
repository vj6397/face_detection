...
class UtilsScanner{
  ...
  static Future<dynamic> dectect({
    required CameraImage image,required Future<dynamic> Function(FirebaseVisionImage image) dectectInImage,required int imageRotation
    })async
  {
    return dectectInImage(
